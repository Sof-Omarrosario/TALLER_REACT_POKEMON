        ...
        <>
            <div>
                {entrenadorActivo ? (
                    <p>
                        Mochilla Activa:{' '}
                        <strong>{entrenadorActivo.nombreCompleto}</strong>
                    </p>
                ) : (
                    <p>
                        No hay entrenador Activo lo siento, valla a RegistroUsuario y lo creas
                    </p>
                )}
            </div>
            ...
            <form onSubmit={buscarPokemon}>
                <div>
                    ...
                    <input
                        ...
                        placeholder="Ej: Charmander, Pikachu"
                    />
                </div>
            ...
            {pokemonActual && (
                <div>
                    ...
                    <p>
                        Experiencia Base:{' '}
                        <strong>{pokemonActual.baseExperience}</strong>
                    </p>
